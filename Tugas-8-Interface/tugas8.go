...
func (t tabung) volume() float64 {
	if int(t.jariJari)%7 == 0 {
		return float64(22 / 7 * t.jariJari * (t.jariJari + t.jariJari))
	} else {
		return float64(3.14 * t.jariJari * (t.jariJari + t.jariJari))
	}
}

func (t tabung) luasPermukaan() float64 {
	if int(t.jariJari)%7 == 0 {
		return float64(2 * 22 / 7 * t.jariJari * (t.jariJari + t.jariJari))
	} else {
		return float64(2 * 3.14 * t.jariJari * (t.jariJari + t.jariJari))
	}
}
